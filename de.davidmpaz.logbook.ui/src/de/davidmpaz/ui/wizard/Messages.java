...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "de.davidmpaz.ui.wizard.messages"; //$NON-NLS-1$
	...
	public static String LogBookProject_Label;
	public static String LogBookProject_Description;
